...
from trips.api.views import TripDetailView, TripLisCreateView, start_trip, finish_trip, generate_qr_trip_validator, \
    validate_qr_trip, join_trip

urlpatterns = [
    path('trips/', TripLisCreateView.as_view(), name='trip-list'),
